...
This repository contains a collection of interactive projects to showcase my skills in:
...
Use the mouse or `arrow keys` + `Enter` to expand and view projects, or subprojects.
...
> Each time the portfolio loads, a random (AI-generated) background theme will be used.
>
> You may scroll through the background art using `Alt` + `wheel | arrow keys`.


## Projects Schema

The projects displayed by this portfolio are built from the `projects.json` file,  
using the following structure:

[Schema for projects.json](./projects-schema.md)